...
private:
	...
	mutable size_type			length;	//��Ч�ַ����ȣ���������β�ַ���
	mutable size_type			realLength;

public:
	static BasicString Empty;	//�մ�
...
private:
	...
	BasicString(const BasicString& des, const BasicString& src, npos _Index, size_type _Length)
	{
		...
		size_type resLength = des.length - _Length + src.length + 1;//�����˽�β����
...
public:
	BasicString() :BasicString(*this, 0, 0){} //Ĭ�Ϲ��캯������һ��1�ַ���String
	...
	BasicString Cat(const BasicString& _Str, npos _Pos)const//��_Str��������ַ�����_Pos��
	{
